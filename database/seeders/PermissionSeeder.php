...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'announcements.publish', 'display_name' => 'Publish Pengumuman',            'module' => 'Announcements'],
            ['name' => 'galleries.view',        'display_name' => 'Lihat Galeri',                  'module' => 'Gallery'],
            ...
            ['name' => 'contact_messages.view',   'display_name' => 'Lihat Permohonan & Pesan',    'module' => 'Contact Messages'],
            ['name' => 'contact_messages.update', 'display_name' => 'Ubah Status Permohonan',      'module' => 'Contact Messages'],
            ['name' => 'contact_messages.delete', 'display_name' => 'Hapus Permohonan & Pesan',    'module' => 'Contact Messages'],
